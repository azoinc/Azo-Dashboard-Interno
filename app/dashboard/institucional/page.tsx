...
export default function InstitucionalPage() {
  return (
    <div className="space-y-4 sm:space-y-6">
      <div>
        <h1 className="text-xl sm:text-2xl font-bold mb-1 sm:mb-2">Institucional</h1>
        <p className="text-muted-foreground text-sm sm:text-base">Relatórios e informações institucionais</p>
      </div>
